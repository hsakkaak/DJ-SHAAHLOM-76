...
let cachedSimsimUrl = null;

// API URL মেমরিতে ক্যাশ করার জন্য ফাংশন (যাতে বারবার গিটহাব রিকোয়েস্ট করে বট স্লো না হয়)
const getMainAPI = async () => {
  if (cachedSimsimUrl) return cachedSimsimUrl;
  try {
    const res = await axios.get(apiList);
    cachedSimsimUrl = res.data.simsimi;
    return cachedSimsimUrl;
  } catch (err) {
    console.error("Error fetching main API:", err.message);
    return null;
  }
};
...
module.exports.config = {
  ...
  version: "1.0.5",
  hasPermssion: 0,
  credits: "ULLASH & FIXED",
  description: "Cute AI Baby Chatbot | Talk, Teach & Chat with Emotion ☢️",
  commandCategory: "Chat",
  usages: "[message/query]",
  cooldowns: 2, // ২ সেকেন্ড কুলডাউন দেওয়া হলো স্প্যামিং কমানোর জন্য
  prefix: true
};
...
module.exports.run = async function ({ api, event, args, Users }) {
  try {
    ...
    if (!simsim) return api.sendMessage("API currently unavailable. Try again later.", event.threadID, event.messageID);
...
module.exports.handleEvent = async function ({ api, event, Users }) {
  try {
    ...
    // যদি অলরেডি বটের মেসেজে কেউ রিপ্লাই দিয়ে কথা বলে, তবে ডাবল রিপ্লাই এড়াতে handleEvent ব্লক করা হলো
    if (event.type === "message_reply" && global.client.handleReply) {
      const replyInfo = global.client.handleReply.find(item => item.messageID === event.messageReply.messageID);
      if (replyInfo && replyInfo.name === module.exports.config.name) return;
    }
    ...
    const greetings = [
      ...
      "শুনবো না😼 তুমি আমার বস ⃝—͟͟͞͞ 𝐒𝐇ꫝꫝ𝐇𝐋𝐎𝐌𓆪 কে প্রেম করাই দাও নাই🥺পচা তুমি🥺",
      "আমি আবাল দের সাথে কথা বলি না,ok😒",
      "এতো ডেকো না,প্রেম এ পরে যাবো তো🙈",
      "Bolo Babu, তুমি কি আমার বস ⃝—͟͟͞͞ 𝐒𝐇ꫝꫝ𝐇𝐋𝐎𝐌𓆪কে ভালোবাসো? 🙈💋",
      ...
      "আমাকে না ডেকে মেয়ে হলে বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 ইনবক্সে চলে যা 🌚😂 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/share/1FLNgJhkaW/",
      "আমাকে বট না বলে , বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 কে জানু বল জানু 😘",
      ...
      "আমাকে ডেকো না,আমি বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 সাথে ব্যাস্ত আছি",
      "কি হলো , মিস্টেক করচ্ছিস নাকি🤣",
      "বলো কি বলবা, সবার সামনে বলবা নাকি?🤭🤏",
      "জান মেয়ে হলে বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 ইনবক্সে চলে যাও 😍🫣💕 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/share/1FLNgJhkaW/",
      ...
      "ভালোবাসার নামক আবলামি করতে চাইলে বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 ইনবক্সে গুতা দিন ~🙊😘🤣 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/share/1FLNgJhkaW/",
      "আমাকে এতো না ডেকে বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 এর কে একটা gf দে 🙄",
      "আমাকে এতো না ডেকছ কেন ভলো টালো বাসো নাকি🤭🙈",
      "🌻🌺💚-আসসালামু আলাইকুম ওয়া রাহমাতুল্লাহ-💚🌺🌻",
      "আমি এখন বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 এর সাথে বিজি আছি আমাকে ডাকবেন না-😕😏 ধন্যবাদ-🤝🌻",
      "আমাকে না ডেকে আমার বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 কে একটা জি এফ দাও-😽🫶🌺",
      "ঝাং থুমালে আইলাপিউ পেপি-💝😽",
      "উফফ বুঝলাম না এতো ডাকছেন কেনো-😤😡😈",
      "জান তোমার বান্ধবী রে আমার বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 হাতে তুলে দিবা-🙊🙆‍♂️",
      "আজকে আমার মন ভালো নেই তাই আমারে ডাকবেন না-😪🤧",
      "ঝাং 🫵থুমালে য়ামি রাইতে পালুপাসি উম্মম্মাহ-🌺🤤💦",
      "চুনা ও চুনা আমার বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 এর হবু বউ রে কেও দেকছো খুজে পাচ্ছি না😪🤧😭",
      "স্বপ্ন তোমারে নিয়ে দেখতে চাই তুমি যদি আমার হয়ে থেকে যাও-💝🌺🌻",
      "জান হাঙ্গা করবা-🙊😝🌻",
      "জান মেয়ে হলে চিপায় আসো বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 থেকে অনেক ভালোবাসা শিখছি তোমার জন্য-🙊🙈😽",
      "ইসস এতো ডাকো কেনো লজ্জা লাগে তো-🙈🖤🌼",
      "আমার বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 পক্ষ থেকে তোমারে এতো এতো ভালোবাসা-🥰😽🫶 আমার বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 ইসলামে'র জন্য দোয়া করবেন-💝💚🌺🌻",
      "- ভালোবাসা নামক আবলামি করতে মন চাইলে আমার বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 এর ইনবক্স চলে যাও-🙊🥱👅 🌻𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 𝐈𝐃 𝐋𝐈𝐍𝐊 🌻:- https://www.facebook.com/share/1FLNgJhkaW/",
      "আমার জান তুমি শুধু আমার আমি তোমারে ৩৬৫ দিন ভালোবাসি-💝🌺😽",
      "কিরে প্রেম করবি তাহলে বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 ইনবক্সে গুতা দে 😘🤌 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/share/1FLNgJhkaW/",
      "জান আমার বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 কে বিয়ে করবা-🙊😘🥳",
      "-আন্টি-🙆-আপনার মেয়ে-👰‍♀️-রাতে আমারে ভিদু কল দিতে বলে🫣-🥵🤤💦",
      "oii-🥺🥹-এক🥄 চামচ ভালোবাসা দিবা-🤏🏻🙂",
      "-আপনার সুন্দরী বান্ধুবীকে ফিতরা হিসেবে আমার বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 কে দান করেন-🥱🐰🍒",
      "-ও মিম ও মিম-😇-তুমি কেন চুরি করলা সাদিয়ার ফর্সা হওয়ার ক্রীম-🌚🤧",
      "-অনুমতি দিলাম-𝙋𝙧𝙤𝙥𝙤𝙨𝙚 কর বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 কে-🐸😾🔪",
      "-编𝙂𝙖𝙮𝙚𝙨-🤗-যৌবনের কসম দিয়ে আমারে 𝐁𝐥𝐚𝐜𝐤𝐦𝐚𝐢𝐥 করা হচ্ছে-🥲🤦‍♂️🤧",
      ...
      "প্রেম করতে চাইলে বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 ইনবক্সে চলে যা 😏🐸 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/share/1FLNgJhkaW/ ",
      "-আজ একটা বিন নেই বলে ফেসবুকের নাগিন-🤧-গুলোরে আমার বস সাহু ধরতে পারছে না-🐸🥲",
      "-চুমু থাকতে তোরা বিড়ি খাস কেন বুঝা আমারে-😑😒🐸⚒️",
      "—যে ছেড়ে গেছে-😔-তাকে ভুলে যাও-🙂-আমার বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 এর সাথে প্রেম করে তাকে দেখিয়ে দাও-🙈🐸🤗",
      "—হাজারো লুচ্চা লুচ্চির ভিরে-🙊🥵আমার বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 এক নিস্পাপ ভালো মানুষ-🥱🤗🙆‍♂️",
      "-রূপের অহংকার করো না-🙂❤️চকচকে সূর্যটাও দিনশেষে অন্ধকারে পরিণত হয়-🤗💜",
      "সুন্দর মাইয়া মানেই-🥱আমার বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌'র বউ-😽🫶আর বাকি গুলো আমার বেয়াইন-🙈🐸🤗",
      "এত অহংকার করে লাভ নেই-🌸মৃত্যুটা নিশ্চিত শুধু সময়টা অ'নিশ্চিত-🖤🙂",
      "-দিন দিন কিছু মানুষের কাছে অপ্রিয় হয়ে যাইতেছি-🙂😿🌸",
      "ভালোবাসার নামক আবলামি করতে চাইলে বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 ইনবক্সে গুতা দিন🤣😼",
      "মেয়ে হলে বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 ইনবক্সে চলে যা 🤭🤣😼 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/share/1FLNgJhkaW/",
      "হুদাই আমারে শয়তানে লারে-😝😑☹️",
      "-𝗜 𝗟𝗢𝗩𝗘 𝗬𝗢🇺-😽-আহারে ভাবছো তোমারে প্রোপজ করছি-🥴-থাপ্পর দিয়া কিডনী লক করে দিব-😒-ভুল পড়া বের করে দিবো-🤭🐸",
      ...
      "-ওই বেডি তোমার বাসায় না আমার বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 মেয়ে দেখতে গেছিলো-🙃-নাস্তা আনারস আর দুধ দিছো-🙄🤦‍♂️-বইন কইলেই তো হয় বয়ফ্রেন্ড আছে-🥺🤦‍♂️-আমার বস সাহু কে জানে মারার কি দরকার-🙄🤧",
      ...
      "-দেশের সব কিছুই চুরি হচ্ছে-🙄-শুধু আমার বস 𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌 এর মনটা ছাড়া-🥴😑😏",
    ...
    const matchedTrigger = triggers.find(t => raw.startsWith(t + " "));
    if (matchedTrigger && simsim) {
      const query = raw.substring(matchedTrigger.length + 1).trim();
      if (!query) return;
